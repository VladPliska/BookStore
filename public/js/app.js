...
window.popup = __webpack_require__(/*! sweetalert2/dist/sweetalert2.min.js */ "./node_modules/sweetalert2/dist/sweetalert2.min.js");
...
$(document).on('click', '.updateAuthor,.removeAuthor', function (e) {
  var curr = $(this);
  var name = $(this).parent().find('.nameAuthor').text();
  var id = $(this).attr('data-id');
  ...
  if ($(this).hasClass('remove')) {
    ...
    var html = '<textarea class=\'news-textarea\' id=\'news\'>' + name + '</textarea>';
    popup.fire({
